...
export function SellHeroCarousel() {
  const t = useTranslations("marketing.commodities.hero");

  const slides: Slide[] = [
    {
      image:
        "https://images.pexels.com/photos/29892493/pexels-photo-29892493.jpeg?auto=compress&cs=tinysrgb&w=1800",
      alt: "African coffee farmer holding freshly harvested cherries",
      badge: t("badge"),
      headline: t("headline"),
      tagline: t("tagline"),
      ctaLabel: t("browseCta"),
      ctaHref: "/commodities/browse",
    },
    {
      image:
        "https://images.pexels.com/photos/3635147/pexels-photo-3635147.jpeg?auto=compress&cs=tinysrgb&w=1800",
      alt: "Cooperative farmers sorting cocoa beans",
      badge: t("slide2.badge"),
      headline: t("slide2.headline"),
      tagline: t("slide2.tagline"),
      ctaLabel: t("slide2.cta"),
      ctaHref: "/request-export",
      steps: [
    ...
    {
      image:
        "https://images.pexels.com/photos/5239818/pexels-photo-5239818.jpeg?auto=compress&cs=tinysrgb&w=1800",
      alt: "Tea plantation rows stretching across rolling African hills",
                  ...
                  {slide.steps.map((step, si) => (
                    <div key={step.num} className="flex items-center gap-2">
                      <div className="flex items-center gap-2.5 pl-2 pr-4 py-2 rounded-full bg-white/12 backdrop-blur-md border border-white/20">
                        <span className="w-6 h-6 rounded-full bg-[var(--terracotta)] text-white text-xs font-black flex items-center justify-center">
                          {step.num}
                        </span>
